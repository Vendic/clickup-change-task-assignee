...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.removeAssignees = exports.addAssignees = void 0;
...
async function addAssignees(task_id, team_id, token, target_assignees) {
    ...
    let result = await axios_1.default.get(endpoint, {
        headers: {
...
exports.removeAssignees = removeAssignees;
...
async function change_assignees() {
    try {
        ...
        for (const task_id of task_ids) {
            try {
                if (add_assignees) {
                    await (0, api_calls_1.addAssignees)(task_id, team_id, token, target_assignees);
                }
                else {
                    await (0, api_calls_1.removeAssignees)(task_id, team_id, token, target_assignees);
                }
            }
            catch (error) {
                failed = true;
...
exports["default"] = change_assignees;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const change_assignees_1 = __importDefault(__nccwpck_require__(9516));
(0, change_assignees_1.default)();
